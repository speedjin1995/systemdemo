        ...
        'columns': [
          ...
          { 
            ...
            render: function ( data, type, row ) {
              return '<div class="row"><div class="col-2"><button type="button" id="edit'+data+'" onclick="edit('+data+')" class="btn btn-success btn-sm"><i class="fas fa-pen"></i></button></div><div class="col-2"><button type="button" id="complete'+data+'" onclick="complete('+data+')" class="btn btn-primary btn-sm"><i class="fas fa-check"></i></button></div><div class="col-2"><button type="button" id="print'+data+'" onclick="print('+data+')" class="btn btn-warning btn-sm"><i class="fas fa-print"></i></button></div><div class="col-2"><button type="button" id="excel'+data+'" onclick="excel('+data+')" class="btn btn-success btn-sm"><i class="fas fa-file-excel"></i></button></div><div class="col-2"><button type="button" id="deactivate'+data+'" onclick="deactivate('+data+')" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i></button></div></div>';
            }
          },
          { 
...
function excel(id) {
    window.open("php/printExcel.php?userID="+id+"&file=weight");
}
